...
const languageContent = {
    ...
    "fr": {
        ...
        "project-1-entity": "OCP Group · Safi, Maroc · Sur site",
        "project-1-date": "Avr 2024 -> Juil 2024",
        "project-1-desc": "• Développé des modèles de maintenance prédictive pour le système de turbine afin de prévoir les pannes potentielles et d'atténuer les temps d'arrêt, ce qui a entraîné une augmentation du temps de fonctionnement opérationnel. Cette approche stratégique a considérablement réduit les coûts liés aux temps d'arrêt tout en optimisant les dépenses de maintenance.<br><br>• Conçu un tableau de bord interactif Power BI, synthétisant des ensembles de données provenant de diverses entités, renforçant ainsi les processus de prise de décision rationalisés dans toute l'organisation.",
